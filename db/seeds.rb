...
Hole.create(holeNumber:'2', map:'<svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" width="500" height="500" name="draw"><polygon points="" fill="#46ad02" name="Fairway" stroke-width="0"></polygon><polygon points="" fill="#49fc03" name="Green" stroke-width="0"></polygon><circle r="5" cx="250" cy="250" name="hole" fill="#ff1100"></circle></svg>', note:'This is course 1 hole 2 note.', course_id:'1')
